...
namespace TopServer {
  ...
  #endif
  {
    ...
    public int TestValue {
      get { return bagMsgCase_ == BagMsgOneofCase.TestValue ? (int) bagMsg_ : 0; }
      set {
        bagMsg_ = value;
    ...
    public override int GetHashCode() {
      ...
      if (bagMsgCase_ == BagMsgOneofCase.TestValue) hash ^= TestValue.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (bagMsgCase_ == BagMsgOneofCase.TestValue) {
